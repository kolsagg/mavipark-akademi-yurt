...
class RoomPanel {
  ...
  getIcon(iconName) {
    const icons = {
      ...
      kitchen: '<svg viewBox="0 0 24 24"><path d="M18.28,5.68A1.5,1.5 0 0,0 16.78,4.18A1.5,1.5 0 0,0 15.28,5.68H9.28A1.5,1.5 0 0,0 7.78,4.18A1.5,1.5 0 0,0 6.28,5.68H3V7.68H21V5.68H18.28M5,9.68V21.68H19V9.68H5M7,11.68H17V13.68H7V11.68M7,15.68H17V17.68H7V15.68Z"/></svg>',
