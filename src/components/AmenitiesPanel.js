...
class AmenitiesPanel {
  ...
  getIcon(iconName) {
    const icons = {
      ...
      hotwater: '<svg viewBox="0 0 24 24"><path d="M12,3C7.03,3 3,7.03 3,12C3,16.97 7.03,21 12,21C16.97,21 21,16.97 21,12C21,7.03 16.97,3 12,3M12,19C8.13,19 5,15.87 5,12C5,8.13 8.13,5 12,5V12L16.24,7.76C18.32,9.85 18.32,13.15 16.24,15.24C14.15,17.32 10.85,17.32 8.76,15.24"/></svg>',
      laundry: '<svg viewBox="0 0 24 24"><path d="M18,2.01L6,2A2,2 0 0,0 4,4V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V4C20,2.89 19.1,2.01 18,2.01M18,20H6V4H18V20M8,6H10V8H8V6M12,13A3,3 0 0,0 15,10A3,3 0 0,0 12,7A3,3 0 0,0 9,10A3,3 0 0,0 12,13M12,9A1,1 0 0,1 13,10A1,1 0 0,1 12,11A1,1 0 0,1 11,10A1,1 0 0,1 12,9Z"/></svg>'
    };
